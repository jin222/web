...
(function($){
    ...
    var CHARACTER = 1,
        ...
        parseCodes = function(value, codeMap) {
                // buffer to hold a collection of keys/char code pairs corresponding to input string value
            var codes = [],
                // buffer to hold the name of a control keys as it's being parsed
                ...
                // buffer to hold construction of current control keys
                currentControlKey = '',
                previousChar = '', 
            ...
            for(var i=0;i<value.length;i++) {
                // if the character is about to define a control keys
                ...
                // if the character is about to end definition of control keys
                    ...
                    value.charAt(i+1) === '}')
                {
                    ...
                    // check if this keys is a modifier-opener (is a ctrl,alt,del,shift)
                    ...
                    // check if this keys is a modifier-closer (is a /ctrl,/alt,/del,.shift)                
                    ...
                    // otherwise is some other kind of non-modifier control keys
                    else 
                    {
                        pushCode({
                ...
                // currently defining control keys
                else if (definingControlKey) 
                {
                ...
                else 
                {
                    ...
                    // of the shift keys in accord with them.
                    if(
        ...
        triggerCodeOnField = function(code, field) {
            ...
            // build out 3 event instances for all the steps of a keys entry
    ...
    $.fn.autotype = function(value, options) {
        ...
        // a logical sequence of steps, keys, and charcodes to apply to the inputs
        ...
        // and cancelable series of keys down/press/up events        
